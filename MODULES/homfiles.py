...
# Last modified: 11-07-2017 12:43:49
...
class ChannelFields:
    ...
    def __init__(self,K,N,M,fstart,fend,fPath='',fPrefix=["upp_Ux","upp_Uy","upp_Uz"]):
        ...
        for x in range(fstart,fend+1):
            self.fNames.append(map(lambda y: fPath + y+"_"+str(x),fPrefix))
