...
# Last modified: 11-07-2017 12:50:42
...
test_set = hf.ChannelFields(128,129,128,2505,2505,fPath = file_path)
test_set1 = hf.ChannelFields(128,129,128,2505,2505,fPath = file_path)
...
class ChannelTest(unittest.TestCase):
    ...
    def test_input(self):
        self.assertSetEqual(set(test_set.__dict__.keys()),
                set(['nFiles','fStart','fEnd','fPath','fNames','field_2505']))
...
class ChannelTest_mean(unittest.TestCase):
    ...
    def test_mean_symm(self):
        thmean = test_set1.statsT("hmean_symm")
        print thmean[1]
        for i in {1,2,3}:
